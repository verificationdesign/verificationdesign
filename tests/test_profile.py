...
class ProfileTests(unittest.TestCase):
    ...
    def test_invalid_profiles(self):
        cases = [
            ...
            ({"expand_on": {"reef_health": {"note": "x", "phrases": ["x"]}}}, (), "collides.*reef_health"),
            ({"keyword_groups": {"reef": []}}, (), "invalid keyword_groups entry: reef"),
            ({"keyword_groups": {"reef": ["coral", " "]}}, (), "invalid keyword_groups entry: reef"),
            ({"expand_on": {"reef": {"note": "x", "phrases": []}}}, (), "invalid expand_on entry: reef"),
            ({"anchor_phrases": ["coral", ""]}, (), "anchor_phrases must be a list of non-blank strings"),
